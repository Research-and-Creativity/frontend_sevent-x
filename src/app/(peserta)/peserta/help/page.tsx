...
export default function PesertaFAQPage() {
  ...
  return (
    <div className="space-y-8 max-w-4xl mx-auto">
      ...
      <Card className="bg-gradient-to-r from-[#0C1738] via-[#0F1E4A] to-[#0A122E] border border-accent/30 rounded-2xl p-6 flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
